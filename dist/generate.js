...
function generateComponent(component, parentPath = '') {
    ...
    const componentPathName = (_b = (_a = component.name) === null || _a === void 0 ? void 0 : _a.trim().replace(/[A-Z]/g, m => "-" + m.toLowerCase())) === null || _b === void 0 ? void 0 : _b.replace(' ', '-');
...
${(_11 = [...new Set([...(_p = innerComponents === null || innerComponents === void 0 ? void 0 : innerComponents.map(comp => `import { ${getComponentName(comp.name)} } from './${comp.dirPath}';`)) !== null && _p !== void 0 ? _p : [],
            ...
            ...(_y = (_x = (_w = component.inputs) === null || _w === void 0 ? void 0 : _w.filter(input => input === null || input === void 0 ? void 0 : input.importTypeUrl)) === null || _x === void 0 ? void 0 : _x.map(input => `import { ${input.type.substring(0, input.type.indexOf('<') ? input.type.indexOf('<') : input.type.length)} } from '${input.importTypeUrl}';`)) !== null && _y !== void 0 ? _y : [],
            ...(_1 = (_0 = (_z = component.outputs) === null || _z === void 0 ? void 0 : _z.filter(output => output === null || output === void 0 ? void 0 : output.importTypeUrl)) === null || _0 === void 0 ? void 0 : _0.map(output => `import { ${output.type.substring(0, output.type.indexOf('<') ? output.type.indexOf('<') : output.type.length)} } from '${output.importTypeUrl}';`)) !== null && _1 !== void 0 ? _1 : [],
            ...(_4 = (_3 = (_2 = component.models) === null || _2 === void 0 ? void 0 : _2.filter(model => model === null || model === void 0 ? void 0 : model.importTypeUrl)) === null || _3 === void 0 ? void 0 : _3.map(model => `import { ${model.type.substring(0, model.type.indexOf('<') ? model.type.indexOf('<') : model.type.length)} } from '${model.importTypeUrl}';`)) !== null && _4 !== void 0 ? _4 : [],
            ...(_6 = (_5 = innerInputs === null || innerInputs === void 0 ? void 0 : innerInputs.filter(input => input === null || input === void 0 ? void 0 : input.importTypeUrl)) === null || _5 === void 0 ? void 0 : _5.map(input => `import { ${input.type.substring(0, input.type.indexOf('<') ? input.type.indexOf('<') : input.type.length)} } from '${input.importTypeUrl}';`)) !== null && _6 !== void 0 ? _6 : [],
            ...(_8 = (_7 = innerOutputs === null || innerOutputs === void 0 ? void 0 : innerOutputs.filter(output => output === null || output === void 0 ? void 0 : output.importTypeUrl)) === null || _7 === void 0 ? void 0 : _7.map(output => `import { ${output.type.substring(0, output.type.indexOf('<') ? output.type.indexOf('<') : output.type.length)} } from '${output.importTypeUrl}';`)) !== null && _8 !== void 0 ? _8 : [],
            ...(_10 = (_9 = innerModels === null || innerModels === void 0 ? void 0 : innerModels.filter(model => model === null || model === void 0 ? void 0 : model.importTypeUrl)) === null || _9 === void 0 ? void 0 : _9.map(model => `import { ${model.type.substring(0, model.type.indexOf('<') ? model.type.indexOf('<') : model.type.length)} } from '${model.importTypeUrl}';`)) !== null && _10 !== void 0 ? _10 : []
